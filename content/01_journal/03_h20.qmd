...
# Simulated data
attrition <- rep(c("No", "Yes"), c(1200, 200))
env_satisfaction <- sample(1:5, 1400, replace = TRUE)

# Combine the data into a data frame
data <- data.frame(Attrition = attrition, Environment_Satisfaction = env_satisfaction)

# Create a ggpairs plot
ggpairs(data, columns = c("Attrition", "Environment_Satisfaction"),
        lower = list(continuous = wrap("smooth", alpha = 0.2, size = 0.7)),
