...
```{r}
# STOCK PRICES
sp_500_prices_tbl_main_dataset <- read_rds("../../../files/sp_500_prices_tbl.rds")
sp_500_prices_tbl_main_dataset
```
...
```{r}
# SECTOR INFORMATION
sp_500_index_tbl_primary <- read_rds("../../../files/sp_500_index_tbl.rds")
sp_500_index_tbl_primary
```
